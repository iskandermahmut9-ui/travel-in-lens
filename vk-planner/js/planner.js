  ...
  async function saveAsJPG() {
        ...
        try {
            ...
            finalCanvas.toBlob(async (blob) => {
                ...
                closeBtn.innerHTML = "✖ ЗАКРЫТЬ И ВЕРНУТЬСЯ";
                closeBtn.style.cssText = 'margin-bottom:20px; padding:15px 30px; background:#FF5722; color:#fff; border:none; border-radius:8px; font-weight:800; font-size:14px; flex-shrink:0; cursor:pointer;';
                ...
                helpText.style.cssText = 'color:#aaa; font-size:12px; margin-top:15px; text-align:center;';
